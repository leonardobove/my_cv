...
\begin{document}
	...
	\begin{itemize}[noitemsep,leftmargin=10.0mm,rightmargin=0mm,topsep=6pt]
		...
		\item Relevant attended courses: \textit{Digital System Design} (FPGA), \textit{Embedded Systems, Microelectronic Systems Design, Mechatronic Systems Design, Wireless Integrated Circuits, Telecommunication Electronics}
