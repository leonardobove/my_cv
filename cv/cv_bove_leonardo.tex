...
\begin{itemize}[noitemsep,leftmargin=3.5mm,rightmargin=0mm,topsep=6pt]
	...
	\item Microwave path engineering: component sizing and selection, and system characterization using RF instrumentation (VNA, spectrum analyzer). Maximization the available SNR in the readout chain without relying on quantum-limited amplifiers.
