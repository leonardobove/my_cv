...
\begin{document}
	...
	\begin{paracol}{2}
		...
		% Name & headline
		\heading{Leonardo Bove}{Quantum Engineer, SQMS Fermilab\\Ph.D. Student in Computer Science}
		...
		\begin{supertabular}{ll}
			\footnotesize\faMapPin & Chicago, IL, USA \\
			\footnotesize\faPhone & +1 708 979 4242 \\
			\footnotesize\faEnvelope & \href{mailto:leonardobove2031@u.northwestern.edu}{leonardobove2031@u.northwestern.edu} \\
	...
	\entry{Ph.D. in Computer Science}{Northwestern University}{Evanston, IL, USA}{Sep. 2026 -- Present}
	\begin{itemize}[noitemsep,leftmargin=10.0mm,rightmargin=0mm,topsep=6pt]
		\item Advisors: Professor Nikos Hardavellas, Professor Kaitlin Smith
		\item Research interests: compilers, algorithms, and infrastructure for fault-tolerant quantum computing (FTQC), quantum error correction, and quantum control, with a focus on the 3D SRF cavity bosonic mode qudit approach
	\end{itemize}

	%\smallskip

	\entry{M.Sc. in Computer Science}{Northwestern University}{Evanston, IL, USA}{Sep. 2026 -- Present}
	...
	\entry{Quantum Engineer}{SQMS, Fermilab}{Batavia, IL, USA}{Jan. 2026 -- Sep. 2026}
	\begin{itemize}[noitemsep,leftmargin=10.0mm,rightmargin=0mm,topsep=6pt]
		\item Calibration of SRF cavities using Quantum Machines control systems (\textit{OPX100} and \textit{OPX+} with \textit{Octave}).
		\item Developed automatic calibration routines using \textit{\href{https://qualibrate.qualang.io/}{Qualibrate}}.
		\item Calibrated the \textit{\href{https://www.rigetti.com/novera}{Novera}} Rigetti QPU using the \textit{OPX1000} platform.
		\item Developed the infrastructure for auto-calibrating the Novera QPU and making it accessible on the cloud for users.
	\end{itemize}
	...
	\begin{minipage}[t]{0.48\textwidth}
		...
		Superconducting qubit \& bosonic cavity mode qudit characterization, Quantum Machines (OPX, OPX+, OPX1000, Octave), Qualibrate, Qiskit, QuTiP \\[4pt]
		\textbf{FPGA Design} \\
