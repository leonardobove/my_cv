...
\begin{itemize}[noitemsep,leftmargin=3.5mm,rightmargin=0mm,topsep=6pt]
  ...
  \item Relevant attended courses: \textit{Wireless Integrated Circuits, Telecommunications, Digital System Design (FPGA), Embedded Systems}
   \item Degree grade: 110/110 \textit{summa cum laude}
...
\begin{itemize}[noitemsep,leftmargin=3.5mm,rightmargin=0mm,topsep=6pt]
  ...
  \item Relevant attended courses: \textit{Solid State Electronics, Programming Languages and Computer Architecture, Programmable Electronic Systems, Computer Systems}
  \item Degree grade: 110/110 \textit{summa cum laude}
  \item Overall GPA: 4.0/4.0
...
\smallskip
Recipient of a 3-month research fellowship titled "Measurement of relaxation and decoherence times in superconducting qubits".
\begin{itemize}[noitemsep,leftmargin=3.5mm,rightmargin=0mm,topsep=6pt]
	\item Characterization of multiple qubits using frequency multiplexing strategies.
	\item Management of the laboratory's dilution refrigerator infrastructure.
	\item Microwave path engineering: component sizing and selection, and system characterization using RF instrumentation (VNA, spectrum analyzer).
	\item FPGA development for qubit control and readout.
...
\begin{itemize}[noitemsep,leftmargin=3.5mm,rightmargin=0mm,topsep=6pt]
	...
	\item Engineered \textit{Qubase}, a Python-based high-level pulse sequencer for the \textit{\href{https://github.com/openquantumhardware/qick}{QICK}} FPGA platform.
	\item Applied Qubase to characterize 2D and 3D superconducting qubits and support advanced quantum experiments.
...
\begin{itemize}[noitemsep,leftmargin=3.5mm,rightmargin=0mm,topsep=6pt]
	\item Directed the development of the University of Pisa's EV race car (\textit{Electronics \& Software Divisions}).
	\item Approved and validated engineering projects.
	\item Oversaw high-voltage battery systems.
	\item Administered and maintained the team's GitLab server.
	\item Coordinated CI pipelines; reviewed pull requests and issue workflows.
...
\begin{itemize}[noitemsep,leftmargin=3.5mm,leftmargin=3.5mm,rightmargin=0mm,topsep=6pt]
...
\begin{itemize}[noitemsep,leftmargin=3.5mm,rightmargin=0mm,topsep=6pt]
	...
	\item Engineered a multi-architecture bootloader (ARM/AVR) with CAN bus support.
	\item Performed unit and integration testing of firmware modules.
\end{itemize}
...
\begin{tabular}{l l}
    ...
    \textbf{English} & C2 level (\textit{Cambridge Assessment English}, overall score of 200 equivalent to IELTS 8.5, 2020) \\
...
Individual lessons and orchestral performances with the \textit{Poliziana Orchestra} at the annual \textit{Cantiere Internazionale d'Arte di Montepulciano}, in addition to periodic symphonic music concerts. Recipient of three merit-based scholarships awarded by the \textit{Cantiere Internazionale d'Arte di Montepulciano} foundation.
