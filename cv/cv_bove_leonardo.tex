...
\begin{itemize}[noitemsep,leftmargin=3.5mm,rightmargin=0mm,topsep=6pt]
  ...
  \item Projects:
    \begin{itemize}
        \item \textbf{Qubase}: superconducting qubit pulse sequencer, based on \textit{Xilinx RFSoC 4x2} FPGA, part of the \textit{\href{https://github.com/openquantumhardware/qick}{QICK}} project of the SQMS research group at Fermilab.
    \end{itemize}
